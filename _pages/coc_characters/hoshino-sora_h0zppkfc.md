...
title: "探索者：星野宙"
layout: single
permalink: /cthulhu/characters/hoshino-sora/
sidebar:
  - title: "星野宙"
    image: /assets/images/coc-character/hoshino-sora.png
    image_alt: "星野宙の画像"
    text: "<strong>プレイヤー:</strong> Sasaku<br><strong>職業:</strong> 学生<br><strong>出身:</strong> 日本<br><strong>年齢:</strong> 23<br><strong>性別:</strong> 男<br><strong>身長/体重:</strong> 170cm/60kg"
---

国際信州大学天文学部の大学４年生。小さいころから星を見ることが好きで、宇宙戦艦ヤマトを作って宇宙に行くことが将来の夢である。自身が好きなことには熱中するがその他のことにはあまり興味がわかない。もちろん天体観測が趣味で、長時間集中して観察することは得意である。最近はＧ郎ラーメンにはまっており、全マシマシに挑戦するか迷っている。(CV: Sasaku)

## 探索者のステータス

**HP**: 14, **MP**: 12, **正気度**: 60

**STR**: 12, **CON**: 13, **POW**: 12, **DEX**: 13, **APP**: 13, **SIZ**: 14, **INT**: 11, **EDU**: 10,
...
<div class="grid__wrapper">
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">聞き耳</td><td class="skill-value">45</td></tr>
  ...
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">母国語</td><td class="skill-value">50</td></tr>
    </table>
  </div>
  <div class="grid__item">
    <h3>知識技能</h3>
    <table class="skill-table">
        ...
        <tr><td class="skill-key">オカルト</td><td class="skill-value">15</td></tr>
        ...
        <tr><td class="skill-key">天文学</td><td class="skill-value">75</td></tr>
        ...
        <tr><td class="skill-key">歴史</td><td class="skill-value">50</td></tr>
    </table>
  </div>
  <div class="grid__item">
    <h3>戦闘技能</h3>
