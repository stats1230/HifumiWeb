...
title: "探索者：日登 旭"
layout: single
permalink: /cthulhu/characters/hinobori-asahi/
sidebar:
  - title: "日登 旭"
    image: /assets/images/coc-character/hinobori-asahi.png
    image_alt: "日登 旭の画像"
    text: "<strong>プレイヤー:</strong> txumo<br><strong>職業:</strong> 占い師<br><strong>出身:</strong> <br><strong>年齢:</strong> 25<br><strong>性別:</strong> 男<br><strong>身長/体重:</strong> "
---
### ・友人との関係性
valorantで知り合った友人、何回かあったことがある、5人目のたこねこは、今回忙しくていない

### ・自分について
基本的に社会不適合。大学を卒業してサラリーマンになったものの、ゲームにはまりすぎて退社。占い師をやりつつなんとか不労所得で生きていけないか毎日考えている。そのくせして訪日観光客にも占いをできるようにするため、英語を学ぶよくわからない真面目さを持つ。(CV: txumo)

## 探索者のステータス

**HP**: 14, **MP**: 14, **正気度**: 70

**STR**: 13, **CON**: 12, **POW**: 14, **DEX**: 8, **APP**: 6, **SIZ**: 15, **INT**: 13, **EDU**: 13,
...
<div class="grid__wrapper">
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">鍵開け</td><td class="skill-value">26</td></tr>
  ...
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">心理学</td><td class="skill-value">55</td></tr>
  ...
  <div class="grid__item">
    <h3>戦闘技能</h3>
    <table class="skill-table">
        <tr><td class="skill-key">回避</td><td class="skill-value">16</td></tr>
        <tr><td class="skill-key">こぶし</td><td class="skill-value">50</td></tr>
        <tr><td class="skill-key">キック</td><td class="skill-value">60</td></tr>
