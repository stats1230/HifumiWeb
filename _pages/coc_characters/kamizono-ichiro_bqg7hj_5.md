...
title: "探索者：神園 威一郎"
layout: single
permalink: /cthulhu/characters/kamizono-ichiro/
sidebar:
  - title: "神園 威一郎"
    image: /assets/images/coc-character/kamizono-ichiro.png
    image_alt: "神園 威一郎の画像"
    text: "<strong>プレイヤー:</strong> Yakizakana<br><strong>職業:</strong> <br><strong>出身:</strong> 日本<br><strong>年齢:</strong> None<br><strong>性別:</strong> <br><strong>身長/体重:</strong> "
---

大人気ゲームVal〇rantに大はまり中のプロカスタネット奏者27歳。耳がいい。世界をまたにかけて活動しているので英語も堪能。趣味は楽譜漁りと天体観測。ボーイスカウトに所属していたので応急手当の知識がある。ヤニカス。
兄弟は姉と義理の兄、父親は他界していて母は姉夫婦と住んでいる。
出身地は福岡県糸島市、現在は北海道札幌市に住んでいる。雪と寒さには強い。(CV: Yakizakana)

## 探索者のステータス

**HP**: 13, **MP**: 12, **正気度**: 60

**STR**: 13, **CON**: 12, **POW**: 12, **DEX**: 12, **APP**: 11, **SIZ**: 14, **INT**: 13, **EDU**: 17,
...
<div class="grid__wrapper">
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">聞き耳</td><td class="skill-value">80</td></tr>
        <tr><td class="skill-key">図書館</td><td class="skill-value">75</td></tr>
        <tr><td class="skill-key">応急手当</td><td class="skill-value">70</td></tr>
  ...
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">説得</td><td class="skill-value">50</td></tr>
  ...
  <div class="grid__item">
    ...
    <table class="skill-table">
        ...
        <tr><td class="skill-key">芸術</td><td class="skill-value">75</td></tr>
        ...
        <tr><td class="skill-key">歴史</td><td class="skill-value">70</td></tr>
    </table>
  </div>
  <div class="grid__item">
    <h3>戦闘技能</h3>
    <table class="skill-table">
        <tr><td class="skill-key">回避</td><td class="skill-value">54</td></tr>
        <tr><td class="skill-key">こぶし</td><td class="skill-value">50</td></tr>
        <tr><td class="skill-key">キック</td><td class="skill-value">50</td></tr>
